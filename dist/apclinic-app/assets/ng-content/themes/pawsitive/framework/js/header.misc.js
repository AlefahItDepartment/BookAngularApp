...
(function ($) {
	...
	function top_tools_search() {
		...
		$('.mainHeader .mainOtherHeader .btSearchInner').prependTo('body').addClass('btFromTopBox');
		//}

		$('.mainHeader .mainOtherHeader .widget_search').addClass('btIconWidget');
		$('.mainHeader .mainOtherHeader .btSearch, .btFromTopBox .btSearchInnerClose').on('click', function () {
	...
	function divide_menu() {
		...
		if ($('.btTextLogo').length) {
			var logoWidth = $('.mainHeader .mainOtherHeader .logo').width();
		} else {
			if ($('.mainHeader .mainOtherHeader .logo .btMainLogo').data('hw')) {
				var logoWidth = $('.mainHeader .mainOtherHeader .logo').height() * $('.mainHeader .mainOtherHeader .logo .btMainLogo').data('hw');
			} else {
				var logoWidth = $('.mainHeader .mainOtherHeader .logo').height() * 3;
			}
		...
		$('.mainHeader .mainOtherHeader .logo').css('transform', 'translateX(' + Math.round(-logoWidth * .5) + 'px)');
		$('.mainHeader .mainOtherHeader .logo').css('width', logoWidth + 'px');
	...
	function boldthemes_calculate_content_padding() {
		if (!belowMenu) {
			if ($(window).width() < window.responsiveResolution || verticalMenuEnabled) {
				...
				$('.btContentWrap').css('padding-top', $('.mainHeader .mainOtherHeader').height() + 'px');
			}
		}
	}
